...
<script  type="text/javascript">
  ...
  <div class="row content">
      ...
      <hr>
        <div class="row">
          <div class="col-sm-12 text-left">
            <p>UDD PMI INDRAMAYU</p>
            <img src="images/house.png">
            <p style="padding-left: 50px;">Jl. Yos Sudarso, Margadadi<br>Indramayu<br>Jawa Barat<br>45211<br>Indonesia</p>
            <img src="images/Phone.png">
            <p style="padding-left: 50px;">(0234) 274644</p>
            <img src="images/faximile.png">
            <p style="padding-left: 50px;">(0234) 274644</p>
            <img src="images/info.png">
            <p style="padding-left: 50px;">Email : Utdpmiindramayu@gmail.com<br>Telephone : (0234) 274644</p><br><br><br><br><br>
               ADD COMMENT
              <hr>
              <?php
    ...
    echo"
            ...
            ";}  ?>
              <hr>
              <form role="form" method='POST' action='proses/insert-komentar.php'> 
